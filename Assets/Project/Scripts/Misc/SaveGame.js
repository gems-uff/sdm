...
//GameTime
	...
	*/
		...
		_PlayerStats.SetCompleted(myData._iUser.completedProjects);
		_PlayerStats.SetFailed(myData._iUser.failedProjects);
		_PlayerStats.SetIncome(myData._iUser.totalIncome);
		_PlayerStats.SetExpenses(myData._iUser.totalExpenses);
		_PlayerStats.SetCompany(myData._iUser.companyLevel);
		_PlayerStats.SetCompanyExperience(myData._iUser.companyExperience);
		*/
	...
	myData._iUser.completedProjects = _PlayerStats.GetCompleted();
	myData._iUser.failedProjects = _PlayerStats.GetFailed();
	myData._iUser.totalIncome = _PlayerStats.GetIncome();
	myData._iUser.totalExpenses = _PlayerStats.GetExpenses();
	myData._iUser.companyLevel = _PlayerStats.GetCompany();
	myData._iUser.companyExperience = _PlayerStats.GetCompanyExperience();
	*/
